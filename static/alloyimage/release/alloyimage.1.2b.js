...
(function (e) {
	...
	window[e].module("config", function (e) {
		var t = {
			Alteration: {
				"\u4eae\u5ea6": "brightness",  //亮度
				"\u8272\u76f8/\u9971\u548c\u5ea6\u8c03\u8282": "setHSI", //色相/饱和度调节
				"\u66f2\u7ebf": "curve",  //曲线
				"gamma\u8c03\u8282": "gamma", //调节
				"\u53ef\u9009\u989c\u8272": "selectiveColor" //可选颜色
			},
			Filter: {
				"\u7070\u5ea6\u5904\u7406": "toGray", //灰度处理
				"\u53cd\u8272": "toReverse",  //反色
				"\u7070\u5ea6\u9608\u503c": "toThresh", //灰度阈值
				"\u9ad8\u65af\u6a21\u7cca": "gaussBlur", //高斯模糊
				"\u6d6e\u96d5\u6548\u679c": "embossment", //浮雕效果
				"\u67e5\u627e\u8fb9\u7f18": "borderline", //查找边缘
				"\u9a6c\u8d5b\u514b": "mosaic",  //马赛克
				"\u6cb9\u753b": "oilPainting",  //油画
				"\u8150\u8680": "corrode",   //腐蚀
				"\u9510\u5316": "sharp",  //锐化
			...
			ComEffect: {
				"\u7f8e\u80a4": "softenFace",  //美肤
				"\u7d20\u63cf": "sketch",  //素描
				"\u81ea\u7136\u589e\u5f3a": "softEnhancement", //自然增强
				"\u7d2b\u8c03": "purpleStyle",  //紫调
				"\u67d4\u7126": "soften",   //柔焦
				"\u590d\u53e4": "vintage", //复古
				"\u9ed1\u767d": "gray",  //黑白
				"\u4efflomo": "lomo",   //lomo
				"\u4eae\u767d\u589e\u5f3a": "strongEnhancement", //亮白增强
				"\u7070\u767d": "strongGray", //灰白
				"\u7070\u8272": "lightGray",  //灰色
				"\u6696\u79cb": "warmAutumn", //暖秋
				"\u6728\u96d5": "carveStyle",  //木雕
			...
			getModuleName: function (e) {
				...
				throw new Error("AI_ERROR:\u8c03\u7528AI\u4e0d\u5b58\u5728\u7684\u65b9\u6cd5" + e)  //不存在的方法
